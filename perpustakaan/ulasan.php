    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active text-white" aria-current="page" href="peminjam.php">Beranda</a>
          </li>
          <li class="nav-item">
    ...
    <div class="d-flex gap-5">
      <div class="card border-0">
        ...
        <button onclick="window.location.href = 'peminjaman_tambah.php?id=<?php echo $id ?>';"
          style="background-color: transparent; border: 1px solid black; border-radius: 5px; padding: 5px 10px; color: black;">Pinjam</button>
        <button>
          <a href="koleksi_proses.php?id=<?php echo $buku['id_buku']; ?> style=" background-color: transparent; border:
            1px solid black; border-radius: 5px; padding: 5px 10px; color: black;" ">Tambah Koleksi</a>
          </button>
        </div>
        ...
        <div class=" ml-5" style="margin-left: 40px">
            ...
            <form id="formUlasan" method="post" action="proses_ulasan.php">
              ...
              <button type="submit"
                style="background-color: transparent; border: 1px solid black; border-radius: 5px; padding: 5px 10px; color: black;">Kirim
                Ulasan</button>
            </form>
